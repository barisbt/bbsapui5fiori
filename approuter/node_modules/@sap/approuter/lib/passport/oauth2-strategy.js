...
OAuth2Strategy.prototype.authenticate = function (req, options) {
  ...
  if (process.env.PRESERVE_FRAGMENT !== 'false') {
    ...
    let redirectCookie = querystring.unescape(cookies[redirectCookieName] && cookies[redirectCookieName][0]);
    redirectCookie = urlUtils.removeQueryParamFromUrl(redirectCookie, 'sap_idp');
